      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mb-12">
          ...
          <div className="md:col-span-5">
            ...
            <div className="flex items-center gap-3">
              <a href={VINCES_WA} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg border border-[var(--border)] flex items-center justify-center text-[var(--text-muted)] hover:border-[var(--gold)] hover:text-[var(--gold)] transition-all"
                aria-label="WhatsApp Vinces">
          ...
          <div className="md:col-span-3 md:col-start-7">
            <div className="label-mono mb-5">Plataforma</div>
