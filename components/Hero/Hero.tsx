...
const LUIS_WA = 'https://wa.me/593996691586?text=Hola%2C%20quiero%20información%20sobre%20Liberty%20Trading%20Club'
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {[
                  ...
                  { icon: '📊', label: 'Trading de CFDs' },
                  { icon: '🏦', label: 'Acciones y Opciones' },
                ].map((v) => (
                  <div key={v.label}
