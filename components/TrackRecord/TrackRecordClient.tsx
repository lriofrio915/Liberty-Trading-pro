...
export default function TrackRecordClient({
  ...
  return (
    <div className="animate-fadeIn">
      ...
      {/* ── Modal 2: Publicado exitosamente ──────────────────────────────── */}
      {socialModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          style={{ background: 'rgba(0,0,0,0.85)' }}
          onClick={e => e.stopPropagation()}>
          <div className="w-full max-w-sm rounded-2xl border overflow-hidden"
            ...
            <div className="px-5 pt-6 pb-4 text-center">
              ...
              <h3 className="text-base font-bold text-white mb-1">¡Post publicado en la comunidad!</h3>
              <p className="text-xs" style={{ color: '#666' }}>
                Tu operación ya es visible para los demás miembros.
              </p>
            </div>
            ...
            <div className="px-5 pb-5 flex flex-col gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-bold transition-opacity hover:opacity-80"
                style={{ background: '#C9A84C', color: '#080808' }}
